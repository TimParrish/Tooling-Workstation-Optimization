# Setup a verified commit using GPG keys on UNIX
...
* If GPG is not installed on your system, add it with your package manager
	...
	* sudo yum install gpg
		* This may vary slightly based on your operating system
...
* These can be verified by using the following command to access your Git global configuration file
	* vim ~/.gitconfig
* [Github documentation for signing commits](https://help.github.com/articles/signing-commits/)

### Test by making your first commit
* Make first commit
	* When prompted, enter the passphrase you created for the GPG key
	* You should be able to navigate to the repository and see that your commit is verified in a green box

### You should now be set up to sign your commits with a gpg key!
